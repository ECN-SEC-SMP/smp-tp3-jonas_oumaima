...
But : Elle permet d'effectuer une érosion sur une image donnée en sauvegardant une nouvelle image avec le préfixe "érodée_".
*/
...
Paramètre d'entrée : 
- structelem : la structure de l'élément structurant
- string : le nom de l'image à traiter
- unsigned int : valeur de seuillage
